...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		long start1=0,end1=0,start2=0,end2=0;double res1=0.0,res2=0.0;
				...
				numToCheck += increment)
		{
			...
			{
				BasicDocument doc=new BasicDocument(str);
				doc.getFleschScore();
				
			}
			end1=System.nanoTime();
			res1=(end1-start1)/1000000000.0;
			...
			res2=(end2-start2)/1000000000.0;
		
			System.out.print(numToCheck+"\t"+res1+"\t"+res2+"\n");
