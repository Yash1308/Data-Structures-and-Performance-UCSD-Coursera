...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		int num=word.length();char ch=' ',c=' ',c2=' ';int count=0,i=0,j=0;
		for(i=0;i<num;i++)
		{
			ch=word.charAt(i);
		...
		if(num>2)
	       c2=word.charAt(num-2);
		if((count>0) && (word.charAt(num-1)=='e') && (c2!='a'&&c2!='e'&&c2!='i'&&c2!='o'&&c2!='u'&&c2!='y'))
			count--;
		if(count==0 && word.charAt(num-1)=='e')
			count++;
