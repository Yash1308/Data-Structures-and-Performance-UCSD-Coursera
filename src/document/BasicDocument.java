...
public class BasicDocument extends Document 
{
	 ...
	 */
	List<String> arr_words;
	List<String> arr_sentences;
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		int num2=0;
		arr_sentences=getTokens("[^.!?]+");
		num2=arr_sentences.size();
        return num2;
	}
	...
	public int getNumSyllables()
	{
		...
		arr_words=getTokens("[(a-z)(A-Z)]+");
		int n=arr_words.size();
		for(int i=0;i<n;i++)
		{
			word=arr_words.get(i);
